...
def _list_keys_result(_result, state, prefix, consumer):
    """
...
def _list_keys_error(failure, _state, prefix):
    """
...
def start_list_keys_tests(state):
    ...
    for prefix in prefixes:
        ...
        deferred.addCallback(_list_keys_result, state, prefix, consumer)
